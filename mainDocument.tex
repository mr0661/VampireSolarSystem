...
\section{World}
	\subsection{Vampirec curses} \label{ssec:curses} % choose mandatory curses
		\input{world_curses.tex}
	\subsection{Vampiric world} \label{ssec:vampire_world}
		\input{world_vampires.tex}
